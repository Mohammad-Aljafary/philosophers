...
/*   Updated: 2025/06/26 10:01:41 by malja-fa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 */
{
	...
	safe_printf("is sleeping", &philo->info->printf_mutex, simulation_time,
		philo);
 ...
 */
{
	...
	safe_printf("is thinking", &philo->info->printf_mutex, simulation_time,
		philo);
	ft_usleep(5, philo);
	return (TRUE);
}
